...
helper.extractPackages = function (data) {
  ...
  var uniqueDeps = helper.isNotObjProp(pckgJson.dependencies);
  var uniqueDevDeps = helper.isNotObjProp(pckgJson.devDependencies);
...
helper.isObjProp = function (obj, pckg) {
  return obj.hasOwnProperty(pckg);

};

helper.isNotObjProp = function (obj) {
  return function (pckg) {
    return !helper.isObjProp(obj, pckg);
  };
